      ...
      <div className="flex flex-col sm:flex-row items-stretch gap-4">
        ...
        <div className="flex gap-2 sm:gap-4">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-blue-500/20 border border-blue-400/50 
             text-blue-300 rounded-xl hover:bg-blue-500/30 transition-all 
             disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <span>Preguntar</span>
            <Send className="w-5 h-5 pt-1" />
          </button>
