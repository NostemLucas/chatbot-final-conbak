...
export const yastaTopics: Topic[] = [
  ...
  {
    id: 10,
    title: "Tarjetas recargables con criptomonedas",
    description:
      "Utiliza tus criptomonedas en el mundo real con las tarjetas de crédito recargables de Efy Finance",
    icon: CreditCard,
    color: "from-purple-500 to-violet-600",
    hasVideo: false,
    intent: "tarjetas-crypto-recargables",
    content: {
      intro:
        "Las tarjetas de crédito recargables con criptomonedas te permiten usar tus activos digitales como medio de pago en comercios físicos y digitales de todo el mundo.",
      steps: [
        "Solicita tu tarjeta recargable desde la app Yasta",
        "Vincula la tarjeta con tu wallet custodia",
        "Recarga la tarjeta directamente con tus criptomonedas",
        "Usa la tarjeta en cualquier comercio que acepte tarjetas",
        "Consulta el saldo y movimientos desde la app",
        "Recarga cuando necesites fondos adicionales",
      ],
      tip: "Puedes recargar las tarjetas directamente con criptomonedas desde tu wallet y utilizarlas como medios de pago en comercios físicos y digitales en todo el mundo.",
      videoDescription: "",
    },
    images: [],
  },
