        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <div className="flex flex-col items-end gap-3">
            ...
            {topic.images && topic.images.length > 0 && (
              <div className="flex items-center gap-2 bg-purple-500/20 px-4 py-2 rounded-full border border-purple-400/50">
            ...
            <div className="mb-6">
              <div className="flex gap-2 overflow-x-auto pb-2">
                {topic.images.slice(0, 3).map((image, index) => (
                  <div
                    key={index}
                    className="flex-shrink-0 w-16 h-16 bg-slate-700/50 rounded-lg border border-slate-600/50 flex items-center justify-center"
                  >
                ...
                {topic.images.length > 3 && (
                  <div className="flex-shrink-0 w-16 h-16 bg-slate-700/50 rounded-lg border border-slate-600/50 flex items-center justify-center">
                    <span className="text-xs text-slate-400">
                      +{topic.images.length - 3}
                    </span>
                  </div>
